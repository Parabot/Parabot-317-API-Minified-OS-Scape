...
public class Calculations extends ReflWrapper {
    ...
    public static Point tileToMap(Tile tile) {
        ...
        Object myPlayer = getFieldValue("LocalPlayer", null);

        return worldToMap((xMapTile * 4 + 2) - (int) getFieldValue("WorldX", myPlayer) / 32,
                (yMapTile * 4 + 2) - (int) getFieldValue("WorldY", myPlayer) / 32);
    }
    ...
    public static Point worldToMap(int regionX, int regionY) {
        int mapScale  = (int) getFieldValue("MapScale", null);
        int mapOffset = (int) getFieldValue("MapOffset", null);
        int angle     = (int) getFieldValue("MapAngle", null);
    ...
    public static final Point worldToCanvas(int regionX, int regionY, int regionZ) {
        ...
        i = i1;
        if (regionZ >= 50) {
            int scale  = (int) getFieldValue("CameraScale", null);
            int width  = (int) getFieldValue("ViewportWidth", null);
            int height = (int) getFieldValue("ViewportHeight", null);
    ...
    public static final int getTileHeight(int regionX, int regionY, int regionZ) {
        ...
        int              k       = regionX;
        final byte[][][] meta    = (byte[][][]) getFieldValue("TileSettings", null);
        final int[][][]  heights = (int[][][]) getFieldValue("TileHeights", null);
