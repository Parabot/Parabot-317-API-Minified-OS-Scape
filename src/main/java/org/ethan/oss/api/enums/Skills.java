...
public class Skills extends ReflWrapper {
    ...
    private static int[] getSkillExpArray() {
        return (int[]) getFieldValue("Experiences", null);
    }

    private static int[] getSkillLevelArray() {
        return (int[]) getFieldValue("CurrentLevels", null);
    }

    private static int[] getRealSkillLevelArray() {
        return (int[]) getFieldValue("RealLevels", null);
    }
